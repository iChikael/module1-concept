...
if (Lang == "en") {
    ...
    var weatherdesc = ["Bão", "Bão nhiệt đới", "Lốc", "Thunderstorm", "Sấm chớp", "Tuyết", "Sleet", "Sleet", "Freezing Drizzle", "Drizzle", "Mưa nặng hạt", "Mưa rào", "Showers", "Flurries", "Snow", "Snow", "Snow", "Hail", "Sleet", "Dust", "Mây mù", "Haze", "Smoky", "Blustery", "gió to", "lạnh", "Mây mù", "Cloudy", "Cloudy", "Cloudy", "Cloudy", "trời trong", "nắng", "Fair", "Fair", "Sleet", "Hot", "Thunderstorms", "Thunderstorms", "Thunderstorms", "Showers", "Heavy Snow", "Light Snow", "Heavy Snow", "Partly Cloudy", "Thunderstorm", "Snow", "Thunderstorm", "blank"];
} 
if (Lang == "cz") {
